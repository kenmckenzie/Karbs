...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/kenmckenzie/PCDots.git"
...
# Keeping this, as I do use both st and dmenu which are still affected by this bug
